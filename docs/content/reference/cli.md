...
```
duckduckgo <command> [arguments] [flags]
```

Run `duckduckgo <command> --help` for the full flag list on any command. This
...
a row here per operation you declare in `duckduckgo/domain.go`.
