...
Most of these come down to network reality or how duckduckgo serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

duckduckgo rate-limits like any public site. duckduckgo already paces
...
Where a surface is gated, duckduckgo reads a cookie or token you supply
...
`duckduckgo`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what duckduckgo actually did
