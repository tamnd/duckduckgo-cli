...
// HTTP behaviour is covered in duckduckgo_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "duckduckgo://page/wiki/Go"; u.String() != want {
	...
	if !h.Searchable("duckduckgo") {
		t.Error("Searchable = false, want true (the domain registers a search op)")
	}

	got, err := h.ResolveOn("duckduckgo", "about")
	if err != nil || got.String() != "duckduckgo://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want duckduckgo://page/about", got.String(), err)
	}
}
